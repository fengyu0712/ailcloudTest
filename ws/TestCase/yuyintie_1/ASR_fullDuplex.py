...
def run():
    ...
    for i in range(len(test_data)):
        ...
        if sessionId is None:
            ...
            rr.write_linedata(rw, i + 2, [asr_result, test_result, sessionId], sheetname=bookname, col=3)
