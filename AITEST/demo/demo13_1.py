...
logs_path = "E:\\log\\20200827\\"

log_paths = Traversing_path.file_all_path(logs_path, filter_str="crc_test")
...
result_path = 'G:\python\AITEST\TestResult\Result\weiyihuanxing_result%s.xls' % (nowdate)
